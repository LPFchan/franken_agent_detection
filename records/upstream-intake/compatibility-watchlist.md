...
| Surface | Why it is sensitive | Questions to ask every time |
| --- | --- | --- |
| Muse event schema and Linux XDG paths | The fork's connector is based on a small verified Muse 0.1.0 corpus | Did upstream or Muse change sequence, event, workspace, or nested-subagent semantics? |
